...
class TestViewVeiculosEdit(TestCase):
    def setUp(self):
        self.instance = Veiculo.objects.create(marca='aaa', modelo='aaa', ano_fabricacao=1, modelo_fabricacao=1, combustivel=1)
...
class TestModelVeiculo(TestCase):
    def setUp(self):
        self.instance = Veiculo.objects.create(marca='aaa', modelo='aaa', ano_fabricacao=datetime.now().year, modelo_fabricacao=datetime.now().year, combustivel=1)
